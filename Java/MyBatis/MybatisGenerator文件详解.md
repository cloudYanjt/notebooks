...
-->
    <context id="Mybatis3Context" defaultModelType="hierarchical" targetRuntime="MyBatis3">
     ...
     -->
        ...
        @TODO:是否可以扩展
     -->
        <jdbcConnection connectionURL="jdbc:mysql://localhost:3306/MyBatisCodeHelper?useUnicode=true&amp;characterEncoding=UTF-8" driverClass="com.mysql.jdbc.Driver" password="admin" userId="admin">
    ...
    -->
        <javaClientGenerator targetPackage="包名（如：cn.admin.sms.core.mapper）" targetProject="src/main/java" type="ANNOTATEDMAPPER">
